...
export const PricingPage: React.FC = () => {
  ...
  const faqs = [
    ...
    {
      q: 'هل يمكن تشغيل النظام محلياً (Offline) وتصدير كود المصدر؟',
      a: 'نعم، المنصة تدعم التشغيل المكتبي ونقاط البيع السريعة دون اتصال، وتتيح لك تصدير الكود المصدري وحزم التطبيق للتشغيل الذاتي بالكامل.'
    },
    {
