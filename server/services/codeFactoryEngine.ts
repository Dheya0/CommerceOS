...
DATABASE_URL=postgresql://postgres:\${POSTGRES_PASSWORD}@localhost:5432/${slug}_db
...
# CORS Allowed Origins (Comma separated, e.g. https://yourdomain.com)
...
> Generated by **CommerceOS Code Factory** — Sovereign Commerce Stack
> You own 100% of the source code. Deploy this project on your own infrastructure.
> Version: \`${version}\` | Target: \`${target}\`

## Architecture Overview
This project is an independent, self-contained commerce application. It does not rely on any proprietary platform hosting.
...
services:
  app:
    ...
    environment:
      - NODE_ENV=production
      - PORT=3000
      - DATABASE_URL=postgresql://postgres:\${POSTGRES_PASSWORD}@db:5432/${slug}_db
